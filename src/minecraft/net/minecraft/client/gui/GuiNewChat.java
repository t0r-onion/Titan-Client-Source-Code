...
public class GuiNewChat extends Gui
{
    ...
    public void printChatMessageWithOptionalDeletion(IChatComponent p_146234_1_, int p_146234_2_) {
        ...
        if (Minecraft.getMinecraft().getCurrentServerData().serverIP.contains("hypixel") && p_146234_1_.getUnformattedText().contains("WINNER!") || p_146234_1_.getUnformattedText().contains("1st Killer -") || p_146234_1_.getUnformattedText().contains("1st Place -") || p_146234_1_.getUnformattedText().contains("Winner: ") || p_146234_1_.getUnformattedText().contains("Winning Team: ") || p_146234_1_.getUnformattedText().contains("Top Seeker: ") || p_146234_1_.getUnformattedText().contains("Winner #1 (") || p_146234_1_.getUnformattedText().contains("Top Survivors"))
        {
