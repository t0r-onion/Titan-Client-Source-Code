...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, j + 72 + -25, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, j + 72 + -25, 98, 20, I18n.format("menu.quit", new Object[0])));
    ...
    { 	
        GlStateManager.disableAlpha();
        GlStateManager.enableAlpha();
        drawBackgroundPicture(1920, 1080, "bg.png");   
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        int i = 274;
        ...
        this.drawCenteredString(fontRendererObj, "Titan Client", sr.getScaledWidth() / 8, sr.getScaledHeight() / 20, 0xffffff);
        //this.drawPicture(sr.getScaledWidth() / 2 - 90, 0, 190, 190, "logo.png");
        GlStateManager.popMatrix();
