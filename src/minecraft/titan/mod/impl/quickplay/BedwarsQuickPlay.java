...
public class BedwarsQuickPlay extends GuiScreen  {
	...
	public BedwarsQuickPlay(GuiScreen p_i1055_1_dada_) {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(102, this.width / 4+117, this.height / 2 - 10, 80, 20, I18n.format("Doubles", new Object[0])));

		this.buttonList.add(new GuiButton(103, this.width / 4+117, this.height / 2 + 20, 80, 20, I18n.format("3v3v3v3", new Object[0])));

		this.buttonList.add(new GuiButton(104, this.width / 4+117, this.height / 2 + 50, 80, 20, I18n.format("4v4v4v4", new Object[0])));

		this.buttonList.add(new GuiButton(105, this.width / 4+117, this.height / 2 + 80, 80, 20, I18n.format("4v4", new Object[0])));

		this.buttonList.add(new GuiButton(106, this.width / 4+117, this.height / 2 + 110, 80, 20, I18n.format("Castle", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 3000:
			...
			break;
		case 100:
			Minecraft.getMinecraft().thePlayer.sendChatMessage("/l b");
			break;
		case 101:
