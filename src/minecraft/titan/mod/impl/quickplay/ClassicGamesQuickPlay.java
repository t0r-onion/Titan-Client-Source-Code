package titan.mod.impl.quickplay;
...
public class ClassicGamesQuickPlay extends GuiScreen  {
	...
	public ClassicGamesQuickPlay(GuiScreen p_i1055_1_dada_) {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(101, this.width / 4+117, this.height / 2 - 40, 80, 20, I18n.format("Vampirez", new Object[0])));

		this.buttonList.add(new GuiButton(102, this.width / 4+117, this.height / 2 - 10, 80, 20, I18n.format("Quake Solo", new Object[0])));

		this.buttonList.add(new GuiButton(103, this.width / 4+117, this.height / 2 + 20, 80, 20, I18n.format("Quake Teams", new Object[0])));

		this.buttonList.add(new GuiButton(104, this.width / 4+117, this.height / 2 + 50, 80, 20, I18n.format("PaintBall", new Object[0])));

		this.buttonList.add(new GuiButton(108, this.width / 4+117, this.height / 2 + 80, 80, 20, I18n.format("Walls", new Object[0])));

		this.buttonList.add(new GuiButton(109, this.width / 4+117, this.height / 2 + 110, 80, 20, I18n.format("Turbo Kart Racers", new Object[0])));

		//-------------------------------------------------------------------------------------------------------------------------------------------

		this.buttonList.add(new GuiButton(105, this.width / 4+20, this.height / 2 - 70, 80, 20, I18n.format("Arena 1v1", new Object[0])));

		this.buttonList.add(new GuiButton(106, this.width / 4+20, this.height / 2 - 40, 80, 20, I18n.format("Arena 2v2", new Object[0])));

		this.buttonList.add(new GuiButton(107, this.width / 4+20, this.height / 2 - 10, 80, 20, I18n.format("Arena 4v4", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 3000:
			...
			break;
		case 100:
			Minecraft.getMinecraft().thePlayer.sendChatMessage("/l cl");
			break;
		case 101:
