...
public class BlitzSGQuickPlay extends GuiScreen {
	...
	public BlitzSGQuickPlay(GuiScreen p_i1055_1_dada_) {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(100, this.width / 4 + 117, this.height / 2 - 70, 80, 20,
				I18n.format("Lobby", new Object[0])));

		this.buttonList.add(new GuiButton(101, this.width / 4 + 117, this.height / 2 - 40, 80, 20,
				I18n.format("Solo", new Object[0])));

		this.buttonList.add(new GuiButton(102, this.width / 4 + 117, this.height / 2 - 10, 80, 20,
				I18n.format("Teams", new Object[0])));

		this.buttonList.add(new GuiButton(1008, this.width / 2 - -222, this.height / 2 + 140, 80, 20,
				I18n.format("Back", new Object[0])));

		// this.buttonList.add(new GuiButton(1024, this.width / 2 - 40, this.height / 2
		// + 50, 80, 20, I18n.format(Slime, new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 3000:
			...
			break;
		case 100:
			Minecraft.getMinecraft().thePlayer.sendChatMessage("/l hg");
			break;
		case 101:
