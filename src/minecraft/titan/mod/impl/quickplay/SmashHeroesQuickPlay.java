...
public class SmashHeroesQuickPlay extends GuiScreen  {
	...
	public SmashHeroesQuickPlay(GuiScreen p_i1055_1_dada_) {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(101, this.width / 4+117, this.height / 2 - 40, 80, 20, I18n.format("Solo 1v1v1v1", new Object[0])));

		this.buttonList.add(new GuiButton(102, this.width / 4+117, this.height / 2 - 10, 80, 20, I18n.format("Teams 2v2", new Object[0])));

		this.buttonList.add(new GuiButton(103, this.width / 4+117, this.height / 2 + 20, 80, 20, I18n.format("Teams 2v2v2", new Object[0])));

		this.buttonList.add(new GuiButton(104, this.width / 4+117, this.height / 2 + 50, 80, 20, I18n.format("1v1 Mode", new Object[0])));

		this.buttonList.add(new GuiButton(105, this.width / 4+117, this.height / 2 + 80, 80, 20, I18n.format("Friends 1v1v1v1", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 3000:
			...
			break;
		case 100:
			Minecraft.getMinecraft().thePlayer.sendChatMessage("/l smash");
			break;
		case 101:
