...
public class CopsAndCrimsQuickPlay extends GuiScreen  {
	...
	public CopsAndCrimsQuickPlay(GuiScreen p_i1055_1_dada_) {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(101, this.width / 4+117, this.height / 2 - 40, 80, 20, I18n.format("Defusal", new Object[0])));

		this.buttonList.add(new GuiButton(102, this.width / 4+117, this.height / 2 - 10, 80, 20, I18n.format("Deathmatch", new Object[0])));

		this.buttonList.add(new GuiButton(103, this.width / 4+117, this.height / 2 + 20, 80, 20, I18n.format("Defusal Party", new Object[0])));

		this.buttonList.add(new GuiButton(104, this.width / 4+117, this.height / 2 + 50, 80, 20, I18n.format("Deathmatch Party", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 3000:
			...
			break;
		case 100:
			Minecraft.getMinecraft().thePlayer.sendChatMessage("/l cc");
			break;
		case 101:
		...
		case 103:
			...
			break;
		case 104:
			Minecraft.getMinecraft().thePlayer.sendChatMessage("/play mcgo_deathmatch_party");
			break;
		}
	}
