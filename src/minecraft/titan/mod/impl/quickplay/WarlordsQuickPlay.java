...
public class WarlordsQuickPlay extends GuiScreen  {
	...
	public WarlordsQuickPlay(GuiScreen p_i1055_1_dada_) {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(100, this.width / 4+117, this.height / 2 - 70, 80, 20, I18n.format("Capture The Flag", new Object[0])));

		this.buttonList.add(new GuiButton(101, this.width / 4+117, this.height / 2 - 40, 80, 20, I18n.format("Domination", new Object[0])));

		this.buttonList.add(new GuiButton(102, this.width / 4+117, this.height / 2 - 10, 80, 20, I18n.format("Team Deathmatch", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 3000:
			...
			break;
		case 100:
			Minecraft.getMinecraft().thePlayer.sendChatMessage("/l w");
			break;
		case 101:
