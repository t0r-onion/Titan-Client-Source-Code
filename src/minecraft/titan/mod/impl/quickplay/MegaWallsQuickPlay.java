...
public class MegaWallsQuickPlay extends GuiScreen  {
	...
	public MegaWallsQuickPlay(GuiScreen p_i1055_1_dada_) {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(101, this.width / 4+117, this.height / 2 - 40, 80, 20, I18n.format("Standard", new Object[0])));

		this.buttonList.add(new GuiButton(102, this.width / 4+117, this.height / 2 - 10, 80, 20, I18n.format("Faceoff", new Object[0])));
