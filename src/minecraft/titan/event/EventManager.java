...
public class EventManager {
    ...
    private static final Map<Class<? extends Event>, ArrayHelper<EventData>> REGISTRY_MAP;
    ...
    private static void register(final Method method, final Object o) {
        ...
        if (EventManager.REGISTRY_MAP.containsKey(clazz)) {
            ...
            EventManager.REGISTRY_MAP.put((Class<? extends Event>) clazz, new ArrayHelper<EventData>() {
    ...
    public static void unregister(final Object o) {
        ...
        for (final ArrayHelper<EventData> flexibalArray : EventManager.REGISTRY_MAP.values()) {
            for (final EventData methodData : flexibalArray) {
    ...
    public static void cleanMap(final boolean b) {
        ...
        final Iterator<Map.Entry<Class<? extends Event>, ArrayHelper<EventData>>> iterator = EventManager.REGISTRY_MAP.entrySet().iterator();
    ...
    private static void sortListValue(final Class<? extends Event> clazz) {
        ...
        final ArrayHelper<EventData> flexibleArray = new ArrayHelper<EventData>();
    ...
    public static ArrayHelper<EventData> get(final Class<? extends Event> clazz) {
    ...
    static {
        REGISTRY_MAP = new HashMap<Class<? extends Event>, ArrayHelper<EventData>>();
    }
